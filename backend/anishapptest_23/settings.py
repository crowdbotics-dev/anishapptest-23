"""
Django settings for anishapptest_23 project.
...
ROOT_URLCONF = 'anishapptest_23.urls'
...
WSGI_APPLICATION = 'anishapptest_23.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "anishapptest_23 API",
    "DESCRIPTION": "API documentation for anishapptest_23 App",
    "VERSION": "v1",
}
